...
<div class="w-full h-full flex flex-col justify-center items-center gap-10">
    <i class="fad fa-hand-sparkles text-9xl text-lime-700 relative"><span class=" absolute top-0 right-0"><i class="fad fa-hand-sparkles text-9xl animate-ping text-gray-700 dark:text-gray-500 opacity-30"></i></span ></i>
